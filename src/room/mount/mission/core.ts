...
import { checkSendMission, colorfyLog, generateID, getRoomDispatchNum, profileMethod, sortByKey } from '@/utils'

/* 房间原型拓展   --任务  --任务框架 */
export default class RoomMissionCoreExtension extends Room {
  /**
   * 执行房间任务
   */
  @profileMethod()
