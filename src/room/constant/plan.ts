...
export const devPlanConstant: BluePrint = [
  ...
  // nuker
  { x: 3, y: 1, structureType: 'nuker', level: 8 },
  // observer
  { x: 6, y: 1, structureType: 'observer', level: 8 },
  // spawn
  { x: -2, y: 0, structureType: 'spawn', level: 8 },
  { x: 2, y: 0, structureType: 'powerSpawn', level: 8 },
  // tower
  { x: 0, y: 1, structureType: 'tower', level: 8 },
  { x: 0, y: -1, structureType: 'tower', level: 8 },
  { x: -1, y: 0, structureType: 'tower', level: 8 },
  // lab
