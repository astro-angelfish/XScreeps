import { colorful, createConst } from '@/utils'
                        ...
                        api: [
                            {
                                ...
                                params: [
                                    { name: 'roomName', desc: '我的房间名' },
                                    { name: 'rtype', desc: 'global(维修最低血量墙) special(没写完)' },
                            ...
                            {
                                title: '一体机',
                                describe: '出动一体机攻击  攻击attack_xxx旗帜下的建筑',
                                params: [
                                    { name: 'roomName', desc: '我的房间名' },
                                    { name: 'disRoom', desc: '目标房间' },
                                    { name: 'shard', desc: '目标shard' },
                                    { name: 'num', desc: '一体机个数 (默认1)' },
                                    { name: 'interval', desc: '出兵间隔时间' },
                            ...
                            {
                                title: '四人小队',
                                describe: '例:war.squad(“E25N1”,"E25N2","shard3:,"A",1000)',
                                params: [
                                    { name: 'roomName', desc: '我的房间名' },
                                    { name: 'disRoom', desc: '目标房间' },
                                    { name: 'shard', desc: '目标shard' },
                                    { name: 'type', desc: '四人小队组合 A D R DR DA RA Aio' },
                                    { name: 'interval', desc: '出兵间隔时间' },
                                ],
                            ...
                            {
                                title: '删除四人小队任务',
                                describe: '例:war.Csquad(“E25N1”,"E25N2","shard3:,"A")',
                                params: [
                                    { name: 'roomName', desc: '我的房间名' },
                                    { name: 'disRoom', desc: '目标房间' },
                                    { name: 'shard', desc: '目标shard' },
                            ...
                            },
                            {
                                ...
                                params: [
                                    { name: 'roomName', desc: '我的房间名' },
                                    { name: 'disRoom', desc: '目标房间' },
                                    { name: 'shard', desc: 'shardname' },
                                    { name: 'interval', desc: '出生间隔' },
                                ],
