...
interface Creep {
    ...
    // 通用移动
    goTo(target: RoomPosition, range: number, ops?: number | null, plain?: number, CustomPositionroad?: any[]): CreepMoveReturnCode | ERR_NO_PATH | ERR_NOT_IN_RANGE | ERR_INVALID_TARGET
    // 请求对穿
