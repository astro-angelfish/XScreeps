    ...
    */
    ...
    public ResourceMarket(): void {
        ...
        if (!Memory.Systemswitch.SystemValidmarket) {
            ...
            if ((Game.time - global.Gtime[this.room.name]) % v_market) return
        }
