...
export const RoleLevelData = {
    ...
    'upgrade': {
        ...
        8: { bodypart: [15, 15, 8, 0, 0, 0, 0, 0], num: 1 },
    },
    'build': {
    ...
    'steal': {
        ...
        3: { bodypart: [0, 2, 2, 0, 0, 0, 0, 0], num: 0 },
        4: { bodypart: [0, 5, 5, 0, 0, 0, 0, 0], num: 0 },
        5: { bodypart: [0, 7, 8, 0, 0, 1, 0, 0], num: 0 },
        6: { bodypart: [0, 8, 10, 0, 0, 2, 0, 0], num: 0 },
        7: { bodypart: [0, 12, 15, 0, 0, 3, 0, 0], num: 0 },
        8: { bodypart: [0, 12, 15, 0, 0, 3, 0, 0], num: 0 },
    },
    'manage': {
        1: { bodypart: [0, 1, 1, 0, 0, 0, 0, 0], num: 0 },
        2: { bodypart: [0, 1, 1, 0, 0, 0, 0, 0], num: 0 },
    ...
    "out-car": {
        ...
        5: { bodypart: [1, 13, 7, 0, 0, 0, 0, 0], num: 0 },
        6: { bodypart: [1, 15, 8, 0, 0, 0, 0, 0], num: 0 },
