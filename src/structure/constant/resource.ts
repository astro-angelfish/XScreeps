export const t3Compounds: ResourceConstant[] = ['XKH2O', 'XKHO2', 'XZH2O', 'XZHO2', 'XGH2O', 'XGHO2', 'XLHO2', 'XLH2O', 'XUH2O', 'XUHO2']
export const t2Compounds: ResourceConstant[] = ['KH2O', 'KHO2', 'ZH2O', 'ZHO2', 'GH2O', 'GHO2', 'LHO2', 'LH2O', 'UH2O', 'UHO2']
export const t1Compounds: ResourceConstant[] = ['KH', 'KO', 'GH', 'GO', 'LH', 'LO', 'ZO', 'ZH', 'UH', 'UO']

type LabReactionMap = Record<string, {
  raw1: ResourceConstant
  raw2: ResourceConstant
}>

// lab 合成相关常量信息
export const labReactionMap: LabReactionMap = {
  // 基本元素
  OH: { raw1: 'H', raw2: 'O' },
  ZK: { raw1: 'Z', raw2: 'K' },
  UL: { raw1: 'U', raw2: 'L' },
...
// 化合物合成顺序 映射
export const ResourceMapData: {
  source: ResourceConstant
  dis: ResourceConstant
  map: ResourceConstant[]
}[] = [
  /*  */
  { source: 'ZK', dis: 'G', map: [] },
